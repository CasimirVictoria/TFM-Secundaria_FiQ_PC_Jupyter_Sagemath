...
* **Tracker:** Importació de dades reals `.csv` amb `pandas`.
...
* **Aclariment metodològic:** Instruments d'**avaluació formativa i reguladora d'aula** (Sanmartí) per a guiar l'aprenentatge, no bateries psicomètriques d'impacte en recerca.
...
Metodològicament, i seguint el marc d'avaluació formadora de Neus Sanmartí, aclarim que aquests instruments són eines d'aula per a regular l'aprenentatge diari i qualificar segons els criteris del Decret 108/2022, i no pas tests psicomètrics de mesura d'impacte científic."
:::
